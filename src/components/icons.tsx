...
export const CircleMinus = defineComponent({
  inheritAttrs: false,
  render() {
    const props: any = this.$attrs
    const { style, ...rest } = toRefs(props)

    return (
      <span {...rest.value}>
        <svg {...getIconStyle(style.value)} viewBox="0 0 24 24" fill="currentColor" preserveAspectRatio="xMidYMid meet">
...
export const SquareMinus = defineComponent({
  ...
  render() {
    const props: any = this.$attrs
    const { style, ...rest } = toRefs(props)
    const svgStyle = getIconStyle(style.value).style
  ...
  render() {
    ...
    return (
      <span {...rest.value}>
        <svg
          style={{
            ...getIconStyle(style.value).style,
            paddingLeft: '2px',
            verticalAlign: 'top',
          }}
          viewBox="0 0 15 15"
...
export const Clippy = defineComponent({
  inheritAttrs: false,
  render() {
    const props: any = this.$attrs
    const { style, ...rest } = toRefs(props)
    ...
    return (
      <span {...rest.value}>
        <svg {...getIconStyle(style.value)} viewBox="0 0 40 40" fill="currentColor" preserveAspectRatio="xMidYMid meet">
          <g>
...
export const RemoveCircle = defineComponent({
  inheritAttrs: false,
  render() {
    const props: any = this.$attrs
    const { style, ...rest } = toRefs(props)
...
export const AddCircle = defineComponent({
  inheritAttrs: false,
  render() {
    const props: any = this.$attrs
    const { style, ...rest } = toRefs(props)
